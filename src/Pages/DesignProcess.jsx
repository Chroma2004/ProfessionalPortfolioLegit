...
function DesignProcess() {
  ...
  useEffect(() => {
    const calculateScrollState = () => {
      ...
      if (mapElement) {
        ...
        const startPoint = isMobile ? viewportHeight * 0.42 : viewportHeight * 0.28;
        ...
        if (hasStarted) {
          const progressDistance = Math.max(
            rect.height - viewportHeight * (isMobile ? 0.45 : 0.35),
            1
          );
        ...
        const progressThreshold = isMobile ? 0.025 : 0.008;

        if (
          Math.abs(lastPathProgressRef.current - nextPathProgress) >
          progressThreshold
        ) {
      ...
      if (footerElement) {
        ...
        const socialCheckY = isSmallScreen
          ? viewportHeight - 92
          : viewportHeight / 2;
  ...
  return (
    ...
    >
      <div
        className={`pointer-events-none fixed inset-0 z-0 sm:animate-[designGridDrift_46s_linear_infinite] motion-reduce:animate-none ${
          isDarkMode
        ...
        <div className="mx-auto max-w-[1500px]">
          ...
          >
            ...
            <div className="relative mx-auto hidden min-h-[1500px] max-w-[1400px] md:block">
              ...
              >
                ...
                <path
                  ...
                  className="transition-[stroke-dashoffset,opacity] duration-150 ease-out will-change-[stroke-dashoffset]"
                />
                  ...
                  return (
                    <g key={`connector-${step.number}`}>
                      ...
                      <circle
                        ...
                        r="9"
                        fill={
                          isReached ? '#FF0000' : isDarkMode ? '#000' : '#d9d9d9'
                        }
                        stroke={isDarkMode ? 'white' : 'black'}
                        strokeWidth="3"
              ...
              <div className="absolute left-[7%] top-[7%] flex items-center gap-2">
                <span
                  className={`text-3xl transition-[color,transform] duration-300 ${
                    pathProgress > 0.02
                ...
                <span
                  className={`border-2 px-4 py-2 text-[10px] font-black uppercase tracking-[0.25em] transition-colors duration-300 ${
                    isDarkMode ? 'border-white' : 'border-black'
                  } ${
                    pathProgress > 0.02
                      ? isDarkMode
              ...
              <div className="absolute left-[74%] top-[87%] flex items-center gap-2">
                <span
                  className={`text-4xl transition-[color,transform] duration-300 ${
                    pathProgress >= 0.94
              ...
              {steps.map((step, index) => {
                ...
                return (
                  <article
                    key={step.number}
                    className={`group absolute w-[250px] -translate-x-1/2 -translate-y-1/2 border-2 p-5 transition-[background-color,color,border-color,transform] duration-300 hover:-translate-y-[56%] ${
                      isDarkMode ? 'border-white' : 'border-black'
                    } ${
                      isReached
                        ? isDarkMode
                  ...
                  >
                    <div
                      className={`absolute -top-5 left-1/2 flex h-10 w-10 -translate-x-1/2 items-center justify-center border-2 text-xs font-black transition-[background-color,color,border-color] duration-300 ${
                        isDarkMode ? 'border-white' : 'border-black'
                      }`}
                      style={{
                    ...
                    <p
                      className={`mt-3 text-xs font-bold leading-relaxed transition-opacity duration-300 ${
                        isReached
                          ? 'opacity-85'
                    ...
                    <div
                      className={`mt-4 h-1 w-full border transition-[background-color,border-color] duration-300 ${
                        isDarkMode ? 'border-white' : 'border-black'
                      }`}
                      style={{
            ...
            <div className="relative z-10 flex flex-col gap-8 md:hidden">
              <div
                className={`mx-auto border-2 px-5 py-2 text-[10px] font-black uppercase tracking-[0.25em] transition-colors duration-300 ${
                  isDarkMode ? 'border-white' : 'border-black'
                } ${
                  pathProgress > 0.02
                    ? isDarkMode
              ...
              {steps.map((step, index) => {
                ...
                return (
                  <div key={step.number} className="relative pl-10">
                    ...
                    <div
                      className="absolute left-4 top-0 h-full border-l-2 transition-colors duration-200"
                      style={{
                    ...
                    <div
                      className={`absolute left-0 top-1 z-10 flex h-9 w-9 items-center justify-center border-2 text-xs font-black transition-[background-color,color,border-color] duration-200 ${
                        isDarkMode ? 'border-white' : 'border-black'
                      }`}
                      style={{
                        backgroundColor: isReached
                    ...
                    <article
                      className={`border-2 p-5 transition-colors duration-300 ${
                        isDarkMode ? 'border-white' : 'border-black'
                      } ${
                        isReached
                          ? isDarkMode
